...
export default function ProductDetailPage() {
  ...
  const { onChangeQuantity, quantity, setQuantity, addToCartQuantity } =
    useCart();
  useEffect(() => {
    setQuantity(1);
  }, []);
                      ...
                      <button
                        onClick={async (event) => {
                          try {
                            ...
                            const data = await addToCartQuantity(
                              Number(productId),
                              quantity
                            );
                        ...
                        className="bg-pp-login-button h-[65px] w-[180px] text-white rounded-lg"
                      >
                        Add to Cart
                      </button>
                    </div>
